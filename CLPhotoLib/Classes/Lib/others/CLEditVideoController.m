...
@property (nonatomic, assign) NSTimeInterval  maxValidTime;
...
- (void)viewWillTransitionToSize:(CGSize)size withTransitionCoordinator:(id<UIViewControllerTransitionCoordinator>)coordinator {
    ...
    [coordinator animateAlongsideTransition: ^(id<UIViewControllerTransitionCoordinatorContext> context) {
         ...
         if (weakSelf.playerLayer.player.currentItem) {
             [weakSelf startTimer];
             weakSelf.timeLabel.text = [CLPhotoModel timeWithFormat:(weakSelf.editView.endRatio - weakSelf.editView.startRatio)*weakSelf.maxValidTime];
         }
     }];
}
